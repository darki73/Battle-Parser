...
Class Parser
{
	...
	public static function ISNSQL($Data)
	{
		...
		echo "INSERT INTO `item_set_names`(`entry`, `name`, `InventoryType`, `WDBVerified`) VALUES ('".$Data['id']."','".$Data['name']."','2','12340');";
		echo '</textarea>';
	}
	...
	public static function PrepareData($Result)
	{
		...
		{
			$Data['dmg_min1'] = round($Result['weaponInfo']['damage']['exactMin']/2, 2);
			$Data['dmg_max1'] = round($Result['weaponInfo']['damage']['exactMax']/2, 2);
			$Data['dmg_type1'] = "0";
			$Data['dmg_min2'] = "0";
			$Data['dmg_max2'] = "0";
			$Data['dmg_type2'] = "0";
		...
		if(isset($Result['itemSpells']))
		{
			...
			for($i = 1; $i <= 5; $i++)
			{
				...
				{
					$Data['spellid_'.$i] = "0";
					$Data['spelltrigger_'.$i] = "0";
					$Data['spellcharges_'.$i] = "0";
					$Data['spellppmRate_'.$i] = "0";
					$Data['spellcooldown_'.$i] = "0";
					$Data['spellcategory_'.$i] = "0";
					$Data['spellcategorycooldown_'.$i] = "0";
				}
			}
		}
